...
class ApresentacaoViewController: UIViewController, UICollectionViewDelegateFlowLayout, UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    let pages = [
        ...
        Apresentacao(imageName: "Apresentacao1", title: "Proposta Pedagógica",  textPresentation: " Inspirar o aluno a ser protagonista, empreendedor, empático, crítico, para pensar e criar soluções que contribuam para um mundo mais solidário, sustentável e justo"),
